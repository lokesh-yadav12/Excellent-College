...
const CTASection = () => {
	...
	return (
		<motion.section
			ref={ref}
			className="relative py-20 text-[#800000] bg-[#FFF8DC] overflow-hidden"
			initial="hidden"
		...
		>
			...
			<div className="container mx-auto px-4 relative z-10">
				<motion.div className="max-w-4xl mx-auto text-center" variants={container}>
					<motion.h2 className="text-3xl md:text-4xl font-extrabold mb-6 text-[#800000]" variants={item}>
						Ready to Join Our School Community?
					</motion.h2>

					<motion.p
						className="text-lg md:text-xl text-[#800000]/90 mb-8 max-w-2xl mx-auto leading-relaxed"
						variants={item}
					>
					...
					{/* CTA Buttons */}
					<motion.div className="flex flex-col sm:flex-row justify-center gap-6" variants={item}>
						{/* Apply Now Button */}
						{/* <motion.div
						...
						>
							<Link
								to="/contact"
								className="relative overflow-hidden group inline-block border-2 border-[#800000] text-[#800000] hover:bg-[#F5DEB3] hover:text-[#800000] font-semibold py-4 px-10 rounded-full transition-all duration-500 hover:shadow-lg"
							>
								<span className="relative z-10 flex items-center">
									Contact Us
									<svg
					...
					{/* Footer Note */}
					<motion.p
						className="mt-8 text-[#800000]/80 text-sm"
