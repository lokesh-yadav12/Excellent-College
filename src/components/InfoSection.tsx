...
const InfoSection: React.FC = () => {
  ...
  return (
    <div className="bg-white/40 px-4 sm:px-10 py-20">
      {/* Top Left Heading */}
      <motion.div
        ...
        {(Object.keys(allInfoData) as DepartmentType[]).map((key, idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Title */}
              <h3 className="text-xl font-semibold p-4 border-b text-[#b24a2f] bg-white sticky top-0 z-10">
                {dept.title}
              </h3>
              ...
              <ul className="flex-1 divide-y overflow-y-auto scrollbar-thin scrollbar-thumb-yellow-600/70">
                {dept.items.map((item, index) => {
                  ...
                  return (
                    <motion.li
                      key={itemKey}
                      className="relative overflow-hidden p-4 text-sm text-gray-700 cursor-pointer select-none"
                    ...
                    >
                      ...
                      <motion.span
                        ...
                        className="absolute inset-0 bg-orange-600/80 origin-left z-0"
                      />
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.92 }}
                className="relative overflow-hidden bg-[#b24a2f] text-white py-3 font-medium flex items-center justify-center gap-2"
              >
                {/* Shimmer */}
