...
const Exploredepartment = () => {
 ...
 const [playingVideo, setPlayingVideo] = useState<string | null>(null);
  ...
  return (
    <section className="bg-gray-50 py-3 sm:py-6 px-4 sm:px-10 text-center ">
      {/* Header */}
      <div className="max-w-7xl mx-auto mb-12 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold mb-4">
          Explore Our <span className="text-red-700">Departments</span>
        </h2>
        <p className="text-md sm:text-lg text-gray-700 max-w-3xl mx-auto border-t-2 border-gray-300 pt-4">
          The aim of the Institute is to provide meaningful education, to conduct original research of the highest
